...
std::vector<ve::VulkanModel::Vertex> getVertexFullRelative( vec3 const& relativeOrigin ) {
...
std::unique_ptr<ve::VulkanModel> createVoxelFullModel( ve::VulkanDevice& vulkanDevice, vec3 const& relativePos )
{
	return std::make_unique<ve::VulkanModel>(vulkanDevice, getVertexFullRelative(relativePos), getIndexRelative(), 0U, ve::MeshLayout::VERTEX | ve::MeshLayout::NORMAL | ve::MeshLayout::TEXTURE);
}
